                          ...
                          child: ExpansionTile(
                            ...
                            title: Row(
                              children: [
                                ...
                                SizedBox(width: 10),
                                Text('Project(s)', style: TextStyle(fontFamily: 'MontMed', fontSize: 13)),
                              ],
                            ),
                            trailing: Icon(
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(width: 5),
                                              Text('Participants: 3', style: TextStyle(fontFamily: 'MontMed', fontSize: 12))
                                            ],
                                          ),
                                        ],
                                      ),
                          ...
                          child: ExpansionTile(
                            ...
                            title: Row(
                              children: [
                                ...
                                SizedBox(width: 10),
                                Text('Task(s)', style: TextStyle(fontFamily: 'MontMed', fontSize: 13)),
                              ],
                            ),
                            trailing: Icon(
                                ...
                                child: Column(
                                  children: allTasks.map((task) {
                                    return ListTile(
                                      ...
                                      title: Text('Task: ${task}', maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(fontFamily: 'MontMed', fontSize: 13)),
                                      subtitle: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Row(
                          ...
                          child: ExpansionTile(
                            ...
                            title: Row(
                              children: [
                                ...
                                SizedBox(width: 10),
                                Text('People(s)', style: TextStyle(fontFamily: 'MontMed', fontSize: 13)),
                              ],
                            ),
                            trailing: Icon(
                                ...
                                child: Column(
                                  children: allPeople.map((project) {
                                    return ListTile(
                                      ...
                                      title: Text('Name: ${project}', maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(fontFamily: 'MontMed', fontSize: 13)),
                                      subtitle: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Row(
