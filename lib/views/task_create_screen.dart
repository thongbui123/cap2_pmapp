          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                        child: ListTile(
                          ...
                          title: Text('Project :', style: TextStyle(fontFamily: 'MontMed', fontSize: 12, color: Colors.black54)),
                          subtitle: Text('PROJECT B', style: TextStyle(fontFamily: 'MontMed', fontSize: 14)),
                          trailing: TextButton(
                        ...
                        child: Container(
                            ...
                            child: Row(
                                children: [
                                  ...
                                  Text('LOW', style: TextStyle(fontFamily: 'MontMed', color: Colors.blue)),
                                  SizedBox(width: 15),
                                  ...
                                  Text('MEDIUM', style: TextStyle(fontFamily: 'MontMed', color: Colors.orange)),
                                  SizedBox(width: 15),
                                  Container(height: 25, width: 2, color: Colors.grey),
                                  SizedBox(width: 15),
                                  Radio<String>(
                                  ...
                                  Text('HIGH', style: TextStyle(fontFamily: 'MontMed', color: Colors.redAccent)),
                                ]
                            )
                        )
                    ),
                ...
                SizedBox(height: 5),
                Divider(),
                Text('Participant(s):', style: TextStyle(fontFamily: 'MontMed', fontSize: 14)),
                Container(
                  child: Column(
                    ...
                    child: TextButton(
                      ...
                      child: Container(
                        child: Row(
                          ...
                          children: [
                            Text('Initiate Task', style: TextStyle(fontFamily: 'MontMed'),),
                            SizedBox(width: 10),
        ...
        return DropdownMenuItem<String>(
          ...
          child: Row(
            children: [
              ...
              SizedBox(width: 5),
              Text(value, style: TextStyle(fontFamily: 'MontMed'),)
            ],
          )
        );
      }).toList(),
